...
CollectExpression.prototype.toAQL = function () {
    return (this._prev ? this._prev.toAQL() + ' ' : '') + 'COLLECT ' + wrapAQL(this._dfns) + (this._varname ? ' INTO ' + wrapAQL(this._varname) + (this._intoExpr ? ' = ' + wrapAQL(this._intoExpr) : this._keep ? ' KEEP' : '') : '') + (this._options ? ' OPTIONS ' + wrapAQL(this._options) : '');
};
